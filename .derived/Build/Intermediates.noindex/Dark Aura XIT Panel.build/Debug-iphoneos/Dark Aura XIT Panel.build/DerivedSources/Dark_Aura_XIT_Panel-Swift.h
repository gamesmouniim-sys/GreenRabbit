...
#ifndef DARK_AURA_XIT_PANEL_SWIFT_H
#define DARK_AURA_XIT_PANEL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Dark_Aura_XIT_Panel",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC19Dark_Aura_XIT_Panel10AdsService")
...
@interface AdsService (SWIFT_EXTENSION(Dark_Aura_XIT_Panel)) <GADFullScreenContentDelegate>
...
@class MAError;
@class MAReward;
@interface AdsService (SWIFT_EXTENSION(Dark_Aura_XIT_Panel)) <MARewardedAdDelegate>
...
@class UIApplication;
SWIFT_CLASS("_TtC19Dark_Aura_XIT_Panel11AppDelegate")
